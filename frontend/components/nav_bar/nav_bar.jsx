...
const userNav = (currentUser, logout) => (
  <div className="navbar-main-user">
    <NavLink to="/explore" className="navbar-logo">
      fliker
    </NavLink>
        ...
        <div className="navbar-info-dropdown-container">
          <div className="navbar-info-dropdown">
            ...
            <p className="navbar-info-dropdown-body">
              A React/Redux architecture completes the frontend for single page app using a Rails backend 
              connected to a PostgreSQL database. Photos are stored using Amazon's S3.
            </p>
            <p className="navbar-info-dropdown-footer"> {gitHub}</p>
          </div>
        </div>
      </div>
      <div className="navbar-avatar-icon">
        <div className="navbar-session-dropdown-container">
          <div className="navbar-session-dropdown">
            ...
            <p className="navbar-session-logout" onClick={() => logout()}>
              Sign Out
            </p>
          </div>
        </div>
